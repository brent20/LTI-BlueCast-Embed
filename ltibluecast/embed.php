...
<tr>
<td>
<p class="text-warning"> <strong>Note: </strong>Viewers will need to log in to view the embedded recording if the session is not set to public. </p>



<input type="text" class="input-block-level" name="recording" placeholder="Paste BlueCast Viewer link here"/></td>
</tr>
...
<center> <button class="btn btn-large btn-block btn-primary" data-loading-text="Generating..." type="submit"><i class="icon-play-circle icon-white"></i> Insert Recording</button></center></td>
